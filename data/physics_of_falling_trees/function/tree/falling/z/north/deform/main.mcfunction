...
function physics_of_falling_trees:tree/falling/leaves/end_pos_z_
...
execute positioned as @s store result score #test main_score if entity @e[type=#physics_of_falling_trees:tree_displays,tag=!poft.ignor_offset,tag=poft.block,limit=6,distance=0.0001..1.9,predicate=physics_of_falling_trees:same_ids]
