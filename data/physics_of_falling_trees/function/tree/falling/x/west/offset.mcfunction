...
scoreboard players operation #offset.pos_y main_score = @s poft.offset_y
...
scoreboard players operation #test main_score = #offset_x_ main_score
...
scoreboard players operation #offset_x_ main_score *= #cos main_score
scoreboard players operation #offset.pos_y main_score *= #sin main_score
scoreboard players operation #offset_x_ main_score -= #offset.pos_y main_score
scoreboard players operation #offset_x_ main_score /= #10000 const
...
execute if score #falled main_score matches 0 run function physics_of_falling_trees:tree/falling/x/west/blocks
