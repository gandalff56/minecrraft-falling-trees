# Hardcore RPG - Load
scoreboard objectives add rpg.xp dummy
scoreboard objectives add rpg.xp_needed dummy
scoreboard objectives add rpg.level dummy
scoreboard objectives add rpg.class dummy
scoreboard objectives add rpg.max_hp dummy
scoreboard objectives add rpg.kills dummy
scoreboard objectives add rpg.deaths dummy
scoreboard objectives add rpg.cd_heal dummy
scoreboard objectives add rpg.cd_undying dummy
scoreboard objectives add rpg.cd_fireball dummy
scoreboard objectives add rpg.cd_lightning dummy
scoreboard objectives add rpg.cd_teleport dummy
scoreboard objectives add rpg.health dummy
...
scoreboard players set #3 rpg.temp 3
scoreboard players set #5 rpg.temp 5
scoreboard players set #20 rpg.temp 20
scoreboard players set #6 rpg.temp 6
scoreboard players set #2 rpg.temp 2
scoreboard players set #4 rpg.temp 4
scoreboard players set #0 rpg.temp 0
