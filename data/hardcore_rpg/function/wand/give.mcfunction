...
# Mage wand
execute if score @s rpg.class matches 3 run give @s minecraft:carrot_on_a_stick[custom_name='{"text":"Magiczna Różdżka","color":"aqua","italic":false}',custom_data={rpg_wand:1b,rpg_class:3}] 1

# Tank wand
execute if score @s rpg.class matches 4 run give @s minecraft:carrot_on_a_stick[custom_name='{"text":"Amulet Obrońcy","color":"dark_aqua","italic":false}',custom_data={rpg_wand:1b,rpg_class:4}] 1
