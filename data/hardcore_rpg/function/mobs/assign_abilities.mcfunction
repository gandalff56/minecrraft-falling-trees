...
execute if entity @s[tag=hrpg.ability_teleport] run data merge entity @s {custom_name_visible:1b,custom_name:["",{"text":"Teleporter","color":"dark_purple"}]}
...
execute if entity @s[tag=hrpg.ability_invis] run data merge entity @s {custom_name_visible:1b,custom_name:{"text":"Phantom","color":"dark_gray"}}
...
execute if entity @s[tag=hrpg.ability_reinforce] run data merge entity @s {custom_name_visible:1b,custom_name:{"text":"Commander","color":"gold"}}
...
execute if entity @s[tag=hrpg.ability_explode] run data merge entity @s {custom_name_visible:1b,custom_name:{"text":"Volatile","color":"dark_red"}}
