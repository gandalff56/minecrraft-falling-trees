...
# Give guide book
give @s minecraft:written_book[written_book_content={title:"Przewodnik RPG",author:"Hardcore RPG",pages:[[{"text":"=== HARDCORE RPG ===\n\n","color":"gold","bold":true},{"text":"Witaj w Hardcore RPG!\n\n","color":"dark_purple","bold":false},{"text":"Zaczynasz z 3 sercami. Zabijaj potwory, zdobywaj XP i wybierz klase na poziomie 1.\n\n","color":"black"},{"text":"Uzyj Amuletu (klik prawym) aby aktywowac umiejetnosci. Wcisnij Q aby przelaczyc spell.","color":"dark_green"}],[{"text":"=== KLASY ===\n\n","color":"gold","bold":true},{"text":"Warrior","color":"red","bold":true},{"text":" - DPS i Melee\nDuzo HP, silne ataki, Szal Berserkera\n\n","color":"black","bold":false},{"text":"Archer","color":"green","bold":true},{"text":" - Szybkosc i Zasieg\nDeszcz Strzal, Pulapki, Unik\n\n","color":"black","bold":false},{"text":"Mage","color":"aqua","bold":true},{"text":" - Zaklecia\nFireball, Heal, Lightning, Teleport\n\n","color":"black","bold":false},{"text":"Tank","color":"dark_aqua","bold":true},{"text":" - Tarcza i Wytrzymalosc\nJedyna klasa z tarcza! 50% mniej obrazen.","color":"black","bold":false}],[{"text":"=== SYSTEM XP ===\n\n","color":"gold","bold":true},{"text":"Zombie: 10 XP\nSkeleton: 15 XP\nCreeper: 12 XP\nEnderman: 20 XP\nWitch: 35 XP\nWither: 300 XP\nDragon: 500 XP\n\n","color":"black"},{"text":"Smierc = -20% XP\n","color":"red"},{"text":"Max 8 zabojstw/min (anti-farm)\nMoby musza zyc 8s aby dac XP","color":"dark_gray"}],[{"text":"=== CRAFTING ===\n\n","color":"gold","bold":true},{"text":"Zelazo: ","color":"black"},{"text":"Poziom 5+\n","color":"dark_green"},{"text":"Zloto: ","color":"black"},{"text":"Poziom 10+\n","color":"gold"},{"text":"Diament: ","color":"black"},{"text":"Poziom 15+\n","color":"aqua"},{"text":"Netherite: ","color":"black"},{"text":"Poziom 25+\n\n","color":"dark_red"},{"text":"Tarcza: ","color":"black"},{"text":"Tylko Tank!\n\n","color":"dark_aqua"},{"text":"Na poziomie 15+ mozesz zresetowac klase:\n","color":"dark_gray"},{"text":"/trigger rpg.trigger set 10\n","color":"dark_red"},{"text":"(koszt: 50% XP)","color":"dark_gray"}],[{"text":"=== BOSSY ===\n\n","color":"gold","bold":true},{"text":"Elite (8%): ","color":"red"},{"text":"XP x1.5\n","color":"black"},{"text":"Mini-Boss (2%): ","color":"dark_red"},{"text":"XP x5 + unikalne looty!\n\n","color":"black"},{"text":"Zombie King\n","color":"dark_red"},{"text":"  -> Korona Zombie Krola\n","color":"gold"},{"text":"Skeleton Sniper\n","color":"dark_purple"},{"text":"  -> Luk Snajpera\n","color":"gold"},{"text":"Creeper Lord\n","color":"dark_green"},{"text":"  -> Rdzen Creepera\n\n","color":"gold"},{"text":"Blood Moon co 3-5 nocy!","color":"red"}],[{"text":"=== ENDGAME ===\n\n","color":"gold","bold":true},{"text":"Smok Apokalipsy\n\n","color":"dark_red","bold":true},{"text":"Wymagania:\n","color":"black","bold":false},{"text":"- 2+ graczy na poziomie 30\n- Zbroja z netherite\n- Wejdz do Endu\n\n","color":"black"},{"text":"Smok ma 2000 HP i 4 fazy!\n","color":"red"},{"text":"Wspolpracujcie aby wygrac.\n\n","color":"dark_green"},{"text":"Nagroda: Smocze Serce + tytul Pogromca Smokow","color":"gold"}]]}] 1
